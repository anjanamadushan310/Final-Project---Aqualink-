...
const ProductDetails = () => {
  ...
  const productData = useMemo(() => ({
    ...
    images: [
      ...
      "https://images.unsplash.com/photo-1520637836862-4d197d17c927?w=400&h=400&fit=crop",
      "https://images.unsplash.com/photo-1591825729269-caeb344f6440?w=400&h=400&fit=crop",
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          <div className="border border-gray-300 rounded-lg p-6 bg-white shadow-sm">
            {/* Price Section */}
            <div className="mb-6">
              <div className="text-sm text-gray-600 mb-2">Price per fish (50-100 size range)</div>
            ...
            <div className="space-y-3">
              ...
              <button className="w-full py-3 px-4 bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 transition-colors flex items-center justify-center gap-2">
        ...
        <div className="border border-gray-300 rounded-lg p-6 bg-white">
          ...
          <div className="prose max-w-none">
            <p className="text-gray-700 leading-relaxed">
              Beautiful Red Blond Guppy fish, perfect for aquarium enthusiasts. These vibrant fish are known for their 
              striking coloration and peaceful temperament. Ideal for community tanks and beginners alike.
            </p>
            <ul className="mt-4 space-y-2">
              <li>• Size: 3cm average</li>
